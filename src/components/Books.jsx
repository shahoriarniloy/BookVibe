...
const Books = ({ item }) => {
    ...
    return (
        <div>
            ...
            <div className='w-[326px] h-[350px] bg-zinc-100 rounded-2xl  mb-6 px-10 py-6 min-w-fit min-h-fit'>
                ...
                <h3 className='text-neutral-900 text-2xl text-left font-bold mt-2'>{bookName}</h3>
